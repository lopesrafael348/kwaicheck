document.addEventListener('DOMContentLoaded', () => {
    const quizData = [
        { question: "Como você avalia sua experiência geral no Kwai?", options: ["😊 Excelente", "🙂 Boa", "😐 Regular", "😞 Ruim"], reward: 62.47 },
        { question: "Como você descobre novos vídeos no Kwai?", options: ["🎯 Feed 'Para você'", "❤️ Seguindo criadores", "#️⃣ Através de hashtags", "👀 Feed 'Seguindo'"], reward: 48.23 },
        { question: "Como você descobre novos vídeos no Kwai?", options: ["🎯 Feed 'Para você'", "❤️ Seguindo criadores", "#️⃣ Através de hashtags", "👀 Feed 'Seguindo'", "✨ Recomendações"], reward: 71.56 },
        { question: "O que te faz seguir um criador no Kwai?", options: ["🤣 Conteúdo divertido", "🎓 Conteúdo educativo", "❤️ Conexão pessoal", "🏆 Participação em desafios", "🗓️ Frequência de postagens"], reward: 39.14 },
        { question: "Qual desses temas de conteúdo você mais gosta de assistir no Kwai?", options: ["😂 Comédia", "💃 Dança", "💡 Tutoriais e dicas", "🤳 Vlogs diários", "💅 Moda e beleza"], reward: 87.65 },
        { question: "Qual horário do dia você mais usa o Kwai?", options: ["☀️ Manhã", "🌇 Tarde", "🌙 Noite", "🌃 Madrugada"], reward: 25.87 },
        { question: "Qual seção do Kwai você mais acessa?", options: ["🎯 Para Você", "❤️ Seguindo", "🔴 Kwai Live", "🔍 Descobrir", "➕ Outro"], reward: 94.32 },
        { question: "Com que frequência você comenta em vídeos do Kwai?", options: ["💯 Sempre", "📈 Frequentemente", "💬 Às vezes", "📉 Raramente", "❌ Nunca"], reward: 16.98 },
        { question: "Você já criou conteúdo no Kwai?", options: ["😎 Sim, frequentemente", "🙂 Sim, ocasionalmente", "🤔 Tentei algumas vezes", "👀 Não, só assisto"], reward: 67.89 },
